...
CREATE TABLE	[dbo].[DimDate]
	(	[DateKey] INT primary key, 
		...
		[SwietoLubNormalny] VARCHAR(50) null,
		[WeekendLubPracujacy] varchar(50) null,
		[PoraRoku] varchar(50) null,
		[DzienTygodnia] varchar(50) null,
...
/* Populate Your Dimension Table with values*/
	...
	SELECT
		...
		CASE DATEPART(DW, @CurrentDate)
			...
			WHEN 7 THEN 0
			END AS IsWeekday,
		NULL AS HolidayUSA, Null, Null, null, null, null, null, null
...
update dbo.DimDate
set SwietoLubNormalny = 'normalny'
go
update dbo.DimDate
set SwietoLubNormalny = 'œwiêto'
where IsHolidayUK = 1 or IsHolidayUSA = 1;
go
update dbo.DimDate
set WeekendLubPracujacy = 'pracujacy'
go
update dbo.DimDate
set WeekendLubPracujacy = 'weekend'
where DayOfWeekUK in (5,6,7);
go
update dbo.DimDate -- 80, 173, 266, 356
set PoraRoku = 'zima';
go
update dbo.DimDate 
set PoraRoku = 'jesieñ'
...
go
update dbo.DimDate
set DzienTygodnia = 'poniedzia³ek'
where DayOfWeekUK = 1
go

update dbo.DimDate
set DzienTygodnia = 'wtorek'
where DayOfWeekUK = 2
go

update dbo.DimDate
set DzienTygodnia = 'œroda'
where DayOfWeekUK = 3
go

update dbo.DimDate
set DzienTygodnia = 'czwartek'
where DayOfWeekUK = 4
go

update dbo.DimDate
set DzienTygodnia = 'pi¹tek'
where DayOfWeekUK = 5
go

update dbo.DimDate
set DzienTygodnia = 'sobota'
where DayOfWeekUK = 6
go

update dbo.DimDate
set DzienTygodnia = 'niedziela'
where DayOfWeekUK = 7
go
...
update dbo.DimDate
set Miesiac= 'sierpieñ'
where month = 8
go

update dbo.DimDate
set Miesiac= 'wrzesieñ'
where month = 9
go

update dbo.DimDate
set Miesiac= 'paŸdziernik'
where month = 10
go

update dbo.DimDate
set Miesiac= 'listopad'
where month = 11
go

update dbo.DimDate
set Miesiac= 'grudzieñ'
where month = 12
go
